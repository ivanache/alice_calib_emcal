...
//=========  (Tue Jun  6 18:08:04 2017) by ROOT version5.34/30
   TCanvas *canvas0 = new TCanvas("canvas0", "calib_emcal.py PbPb_globallyGood/AnalysisResults_0031.root",65,52,1684,835);
   gStyle->SetOptStat(0);
